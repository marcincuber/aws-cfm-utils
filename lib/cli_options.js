...
const cliopts = (argv) => {
  return require('yargs')
    ...
    .options({
      ...
      'capabilities': {
        type: 'array',
        choices: ['CAPABILITY_NAMED_IAM', 'CAPABILITY_IAM','CAPABILITY_AUTO_EXPAND']
      },
      'on-failure': {
        type: 'string',
    ...
    .implies('sessiontoken', 'accesskeyid')
    .implies('sessiontoken', 'secretkey')
    .conflicts('accesskeyid', 'profile')
    .conflicts('secretkey', 'profile')
    .conflicts('sessiontoken', 'profile')
